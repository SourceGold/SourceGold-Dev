...
public class EnemyLocomotionManager : LocomotionManager
{
    ...
    public void HandleMoveToTarget()
    {
        ...
        {
            _horizontalVelocity = Mathf.Lerp(_horizontalVelocity, 0f, 0.5f);
            _navMeshAgent.enabled = false;
        } 
        else
        {
            ...
            {
                _horizontalVelocity = Mathf.Lerp(_horizontalVelocity, 0.5f, 0.5f);
            }
        ...
        _enemyAnimatorManager.Animator.SetFloat("HorizontalVelocity", _horizontalVelocity);
